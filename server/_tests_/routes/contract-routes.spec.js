...
describe.skip('Contract Endpoints', () => {
  ...
  it('GET /entity/:entityId/contract will return 200 if no contracts are in the Db', async (done) => {
    const res = await request.get(`/entity/${mockEntities[0]._id}/contract`);
